...
class PositionalEmbedding(torch.nn.Module):
    def __init__(self, max_length, out_dim):
        ...
        div_term = torch.exp(torch.arange(0, out_dim, 2) * -(torch.log(torch.tensor(10000.0)) / out_dim))
...
class TransformerEmbedding(torch.nn.Module):
    def __init__(self, n_vocab, max_length, out_dim, dropout_rate=0.1):
        super().__init__()
...
def create_dataloader_v1(txt, batch_size, max_length=256, stride=128, shuffle=False,
